        ...
        <Layout style={styles.container}>
            ...
            <Modal visible={visibleChangePassword} backdropStyle={styles.backdrop} onBackdropPress={toggleModalChangePassword}>
                <Card disabled={true}>
                    ...
                    <Input placeholder='New Password' value={password} style={styles.inputPassword} onChangeText={setPassword} secureTextEntry={true} />
                    <Input placeholder='Confirm Password' value={confirmPassword} onChangeText={setConfirmPassword} secureTextEntry={true} />
                    <Button style={styles.button} appearance='outline' status='info' onPress={toggleModalChangePassword}>Cancel</Button>
                    <Button style={styles.button} status='info' onPress={handlePasswordChange}>Change Password</Button>
                </Card>
            </Modal>
